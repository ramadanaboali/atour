            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h1 class="bold mb-0 mt-1 text-dark">
                        ...
                        <span>{{ __('settings.client_terms') }}</span>
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div id="translations-wrapper" class="w-100">
                        @php
                        $translations = old('translations', $item->clientTermsTranslations ?? []);
