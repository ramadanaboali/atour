...
@endpush
@section('content')
<form method='post' enctype="multipart/form-data" id="jquery-val-form" action="{{ isset($item) ? route('admin.gifts.update', $item->id) : route('admin.gifts.store') }}">
    @csrf
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div id="translations-wrapper">
                            ...
                            <div class="border rounded p-1 row bg-light translation-row" data-locale="{{ $t['locale'] ?? $t->locale }}">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('gifts.location') }}</label>
                                    <input type="text" class="form-control" name="translations[{{ $index }}][location]" value="{{ $t['location'] ?? '' }}" placeholder="{{ __('gifts.location') }}">
                                </div>
                    ...
                    <div class="mb-1 col-md-4  @error('sub_category_ids') is-invalid @enderror">
                        ...
                        <select name="sub_category_ids[]" id="sub_category_ids" class="form-control ajax_select2 extra_field" data-ajax--url="{{ route('admin.sub_categories.select') }}" data-ajax--cache="true" multiple>
...
<script>
    ...
    document.getElementById('add-translation').addEventListener('click', function() {
      ...
      <div class="col-md-6">
          <label class="form-label">{{ __('gifts.location') }}</label>
          <input type="text" class="form-control" name="translations[${index}][location]" value="" placeholder="{{ __('gifts.location') }}">
      </div>
