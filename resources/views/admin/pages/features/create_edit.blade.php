...
@endsection
@section('content')
<form method='post' enctype="multipart/form-data" id="jquery-val-form" action="{{ isset($item) ? route('admin.features.update', $item->id) : route('admin.features.store') }}">
            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h1 class="bold mb-0 mt-1 text-dark">
                        ...
                        <span>{{ isset($item) ? __('features.actions.edit') : __('features.actions.create') }}</span>
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="mb-1 breadcrumb-right">
                <div class="dropdown">
                    <button class="btn btn-sm btn-outline-primary me-1 waves-effect">
                        ...
                        <span class="active-sorting text-primary">{{ __('features.actions.save') }}</span>
                    </button>
                </div>
            </div>
        </div>
