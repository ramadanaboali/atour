...
@endsection
@section('content')
<form method='post' enctype="multipart/form-data" id="jquery-val-form" action="{{ isset($item) ? route('admin.onboardings.update', $item->id) : route('admin.onboardings.store') }}">
            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h1 class="bold mb-0 mt-1 text-dark">
                        ...
                        <span>{{ isset($item) ? __('onboardings.actions.edit') : __('onboardings.actions.create') }}</span>
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="mb-1 breadcrumb-right">
                <div class="dropdown">
                    <button class="btn btn-sm btn-outline-primary me-1 waves-effect">
                        ...
                        <span class="active-sorting text-primary">{{ __('onboardings.actions.save') }}</span>
                    </button>
                </div>
            </div>
        </div>
