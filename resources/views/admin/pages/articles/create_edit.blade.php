                            ...
                            <div id="translations-wrapper">
                                ...
                                <div class="border rounded p-1 row bg-light translation-row" data-locale="{{ $t['locale'] ?? $t->locale }}">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="translations[{{ $index }}][tags]" placeholder="{{ __('articles.tags') }}">{{ $t['tags'] ?? '' }}</textarea>
                                    </div>
...
<script>
    ...
    document.getElementById('add-translation').addEventListener('click', function() {
        ...
        <div class="col-md-12">
            <label class="form-label">{{ __('articles.tags') }}</label>
            <textarea class="form-control" name="translations[${index}][tags]" placeholder="{{ __('articles.tags') }}"></textarea>
        </div>
