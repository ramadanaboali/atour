...
@section('content')
    <form method='post' enctype="multipart/form-data"  id="jquery-val-form"
          action="{{ isset($item) ? route('admin.departments.update', $item->id) : route('admin.departments.store') }}">
                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h1 class="bold mb-0 mt-1 text-dark">
                            ...
                            <span>{{ isset($item) ? __('departments.actions.edit') : __('departments.actions.create') }}</span>
                        </h1>
                    </div>
                </div>
            </div>
                ...
                <div class="mb-1 breadcrumb-right">
                    <div class="dropdown">
                        <button class="btn btn-sm btn-outline-primary me-1 waves-effect">
                            ...
                            <span class="active-sorting text-primary">{{ __('departments.actions.save') }}</span>
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-1 col-md-2  @error('active') is-invalid @enderror">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="active">{{ __('departments.active') }}</label>
                            </div>
                            @error('active')
