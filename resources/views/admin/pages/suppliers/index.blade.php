                    ...
                    <div class="row">
                        <div class="mb-1 col-md-6  @error('can_pay_later') is-invalid @enderror">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="can_pay_later" value="1" id="can_pay_later" />
                        ...
                        <div class="mb-1 col-md-6  @error('can_cancel') is-invalid @enderror">
                            <br>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="can_cancel" value="1" id="can_cancel" />
                        ...
                        <div class="mb-1 col-md-6  @error('pay_on_deliver') is-invalid @enderror">
                            <br>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="pay_on_deliver" value="1" id="pay_on_deliver" />
                        ...
                        <div class="mb-1 col-md-6  @error('ban_vendor') is-invalid @enderror">
                            <br>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="ban_vendor" value="1" id="ban_vendor" />
