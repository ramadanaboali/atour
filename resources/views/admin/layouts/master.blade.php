...
<body class="pace-done vertical-layout vertical-menu-modern navbar-floating footer-static menu-expanded" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <div class="modal fade text-start" id="modalRestore" tabindex="-1" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog">
            <form id="restoreForm" method="post" action="">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-sm btn-danger">{{ __('users.dialogs.restore.confirm') }}</button>
                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">{{ __('users.dialogs.delete.cancel') }}</button>
                    </div>
                </div>
            </form>
        </div>
