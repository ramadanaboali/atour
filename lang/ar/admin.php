...
return [
    ...
    'dialogs' => [
        'delete' => [
            'title' => 'حذف العنصر',
            'info' => 'هل أنت متأكد من أنك تريد حذف هذا العنصر؟',
            'confirm' => 'حذف',
            'cancel' => 'إلغاء',
        ],
        'save' => [
            'title' => 'تأكيد الحفظ',
            'message' => 'هل تريد حفظ هذه التغييرات؟',
            'info' => 'يرجى مراجعة المعلومات قبل الحفظ.',
            'confirm' => 'نعم، احفظ',
            'cancel' => 'إلغاء',
        ],
        'client_status' => [
            'title' => 'تغيير حالة العميل',
            'info' => 'هل أنت متأكد من أنك تريد تغيير حالة العميل؟',
            'confirm' => 'تأكيد',
            'cancel' => 'إلغاء',
        ],
        'settlement' => [
